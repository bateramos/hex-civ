...
impl HexEvent {
    ...
    pub fn new_from_position(name: &str, position: Vector2u) -> HexEvent {
    ...
    pub fn new_from_unit_position(name: &str, unit: &Unit, position: Vector2u) -> HexEvent {
